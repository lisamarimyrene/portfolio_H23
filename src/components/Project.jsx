    ...
    return (
        <div className="flex justify-center pt-7 md:pt-0 ">
            <div className={`z-10 w-[80%] flex flex-col ${side === 'left' ? 'items-start' : 'items-end'}`}>
                ...
                <Link to={`/project/${title}`}><h3 className="hover:text-opacity-50 hover:line-through tracking-normal text-purple_light py-2 md:py-3 font-seymour text-xl md:text-2xl uppercase">{title}</h3></Link>
