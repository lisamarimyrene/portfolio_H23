...
export const ProjectSection = () => {
    ...
    return (
        <section className="bg-gray-light text-gray-dark relative w-screen overflow-hidden pb-16 md:pt-24">
            ...
            <div className="flex flex-row text-gray-dark text-lg w-[75%] my-16 md:my-24 justify-between ml-12 md:ml-56 items-center">
                <div>
